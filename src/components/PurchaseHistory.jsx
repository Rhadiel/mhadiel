                    ...
                    <li key={purchase.id}>
                        <div className="purchase-details">
                            ...
                            <div className="purchase-detail">
                                ...
                                <span className="detail-value" style={{ color: purchase.status === 'Paid' ? 'green' : 'red' }}>
                                    {purchase.status}
                                </span>
                                <button className="status-button" onClick={() => handleStatusChange(purchase.id, purchase.status)}>
